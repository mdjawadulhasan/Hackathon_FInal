...
if (isset($_POST["submit"])) {
    ...
    $sql = "INSERT INTO users(Uname,Pass,UType,UType_Criteria,email) VALUES ('$user_name','$user_pass','$UType','$UType_Criteria','$user_email')";
    ...
    if (isset($user_name) && isset($user_pass)) {
        ...
        if ($usernameInDB === $user_name) {
            ...
            header("refresh: 0.5; url=GovtSignin.php");
            mysqli_close($conn);
            ...
            if (mysqli_query($conn, $sql)) {
                ...
                header("refresh: 1; url=GovtHome.php");
                mysqli_close($conn);
            } else {
